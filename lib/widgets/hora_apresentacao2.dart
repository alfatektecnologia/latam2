...
class HoraApresentacao2 extends StatefulWidget {
  @override
  _HoraApresentacao2State createState() => _HoraApresentacao2State();
}

class _HoraApresentacao2State extends State<HoraApresentacao2> {
