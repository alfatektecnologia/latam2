...
class HoraLastPouso2 extends StatefulWidget {
  @override
  _HoraLastPouso2State createState() => _HoraLastPouso2State();
}

class _HoraLastPouso2State extends State<HoraLastPouso2> {
  ...
  Widget build(BuildContext context) {
    ...
    getTime() {
      setState(() {
        //getTime();
        Util.horaVooIdaPouso = timeSelected;
        Util.hasHoraPouso = true;
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text('Horário previsto do último pouso:',
