...
class TerminoSobreaviso2 extends StatefulWidget {
  @override
  _TerminoSobreaviso2State createState() => _TerminoSobreaviso2State();
}

class _TerminoSobreaviso2State extends State<TerminoSobreaviso2> {
  String _dataTerminoSobreaviso = 'HH:MM';
  @override
  Widget build(BuildContext context) {
    ...
    getTime() {
      setState(() {
        //getTime();
        Util.horarioTerminoSobreaviso = timeSelected;
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            timeSelected!=null
                            ? Navigator.of(context).pop()
                            : Util.showFlushbar(context,'Selecione um horário');
                          },
                          child: Text('OK',
                              style: TextStyle(
                                  fontSize: 20,
                    ...
                    child: CupertinoDatePicker(
                        ...
                        onDateTimeChanged: (date) {
                          setState(() {
                            ...
                            _dataTerminoSobreaviso = newFormatedDate;
                            timeSelected = date;
                            getTime();
                          });
                        }),
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text('Horário de término do sobreaviso:',
