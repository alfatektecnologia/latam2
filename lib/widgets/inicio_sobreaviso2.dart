...
class InicioSobreaviso2 extends StatefulWidget {
  @override
  _InicioSobreaviso2State createState() => _InicioSobreaviso2State();
}

class _InicioSobreaviso2State extends State<InicioSobreaviso2> {
  String _dataInicioSobreaviso = 'HH:MM';
  @override
  Widget build(BuildContext context) {
    ...
    getTime() {
      setState(() {
        //getTime();
        Util.horarioInicioSobreaviso = timeSelected;
                    ...
                    child: CupertinoDatePicker(
                        ...
                        onDateTimeChanged: (date) {
                          setState(() {
                            ...
                            _dataInicioSobreaviso = newFormatedDate;
                            timeSelected = date;
                            getTime();
                          });
                        }),
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text('Horário de início do sobreaviso:',
