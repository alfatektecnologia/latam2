...
class HoraLastPouso3 extends StatefulWidget {
  @override
  _HoraLastPouso3State createState() => _HoraLastPouso3State();
}

class _HoraLastPouso3State extends State<HoraLastPouso3> {
  String _horaLastPouso = 'HH:MM';
  ...
  Widget build(BuildContext context) {
    ...
    getTime() {
      setState(() {
        //getTime();
        Util.horaVooVoltaPouso = timeSelected;
        Util.hasHoraPouso2 = true;
                    ...
                    child: CupertinoDatePicker(
                        ...
                        onDateTimeChanged: (date) {
                          setState(() {
                            ...
                            _horaLastPouso = newFormatedDate;
                            timeSelected = date;
                            getTime();
                          });
                        }),
    ...
    return Container(
      child: Column(
        ...
        children: <Widget>[
          Text('Horario previsto do último pouso:',
